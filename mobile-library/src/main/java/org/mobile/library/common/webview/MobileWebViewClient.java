...
public class MobileWebViewClient extends WebViewClient {
    ...
    public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
        ...
        view.loadUrl("javascript:document.title=\"" + ContextUtil.getContext().getString(
                R.string.web_view_load_error_title) + "\";document.body.innerHTML=\"" + ContextUtil.getContext().getString(R.string.web_view_load_error_body) + "\"");
    }
