 ...
 */
package org.mobile.library.scan.activity;
...
import org.mobile.library.scan.utils.CaptureActivityHandler;
import org.mobile.library.scan.utils.DecodeStatus;
import org.mobile.library.scan.utils.InactivityTimer;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    public void restartPreviewAfterDelay(long delayMS) {
        if (handler != null) {
            handler.sendEmptyMessageDelayed(DecodeStatus.RESTART_PREVIEW, delayMS);
        }
    }
