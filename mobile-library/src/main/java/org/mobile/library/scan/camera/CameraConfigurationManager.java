 ...
 */
package org.mobile.library.scan.camera;
...
public final class CameraConfigurationManager {
    ...
    public void initFromCameraParameters(Camera camera) {
        ...
        Log.v(TAG, "Camera resolution x: " + cameraResolution.x);
        Log.v(TAG, "Camera resolution y: " + cameraResolution.y);
    }
    ...
    private Point findBestPreviewSizeValue(Camera.Parameters parameters, Point screenResolution) {
        ...
        if (!supportedPreviewSizes.isEmpty()) {
            ...
            Log.v(TAG, "Using largest suitable preview size: " + largestSize);
            return largestSize;
        }
        ...
        Log.v(TAG, "No suitable preview sizes, using default: " + defaultSize);
